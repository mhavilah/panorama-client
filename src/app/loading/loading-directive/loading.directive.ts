 ...
 * 
 * Provides a tag, [appIsLoading] for use in a template.
 * 
 * eg:
 *   <div [appIsLoading]="loadingService.isLoading(this, LoadingIndicator.ASYNC_PIPE)">
 * 
 * Requires 'decoration' of an async pipe within the underlying component, and,
 * a spinner style 'lds-ring' within the global styles.css
 * 
 * See: loading-spinner component.
 * 
 * From: https://github.com/radekbusa/angular-loading-indicators-the-right-way
 */
import {
    ChangeDetectorRef,
